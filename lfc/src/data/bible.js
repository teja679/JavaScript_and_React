...
export class Bible extends React.Component {
  render() {
    return (
      <div className="bibleBag">
        <div className="bgOverlay"></div>
        <div className="bibleBg">
          <img src={biblebag} alt="Bible Background Family Harvest Church" />
        </div>
        <BibleCom />
      </div>
    );
...
export class BibleCom extends React.Component {
  ...
  chapterChange = (e) => {
    ...
    if (e.target.value !== "Select Chapter") {
      var disp = " ",
        dispData =
          []; /*this.state.json[this.state.book][e.target.value]((user, index) => (
            <option value={user}>{user}</option>
        ));*/

      var nV = Object.keys(
        this.state.json[this.state.book][e.target.value]
      ).length;
      for (var i = 1; i <= nV; i++) {
        disp =
          ...
          i.toString() +
          ". " +
          this.state.json[this.state.book][e.target.value][i] +
          "\n";
        dispData[i] = disp;
      }
      var vkeys = [];
  ...
  verseChange = (e) => {
    ...
    if (e.target.value !== "Select Verse") {
      var disp =
        this.state.chap.toString() +
        ":" +
        e.target.value.toString() +
        ". " +
        this.state.json[this.state.book][this.state.chap][e.target.value];
      ...
      <div>
        <div className="biblepage">
          <div className="biblebody">
            ...
            <select
              id="Chapter"
              onChange={this.chapterChange.bind(this)}
              name="Chapter"
            >
            ...
            <select
              id="Verse"
              onChange={this.verseChange.bind(this)}
              name="Verse"
            >
